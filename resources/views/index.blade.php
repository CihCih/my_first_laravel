    ...
    <div id="section3" class="goods-photo container-fluid d-flex">
        ...
        <div class="goods-photo-bottom d-flex justify-content-center">
            ...
            <div class="goods-photo-right d-flex">
                <div class="r-box3"><img src="{{ asset('img/homepage-img/section3-p4.jpg') }}" alt="">
                </div>
                <div class="r-box1"><img src="{{ asset('img/homepage-img/section3-p5.jpg') }}" alt="">
                </div>
                <div class="r-box2"><img src="{{ asset('img/homepage-img/section3-p6.jpg') }}" alt="">
                </div>
            ...
            <div class="card mb-3 ">
                <div class="card-container row g-0 d-flex align-items-center">
                    <div class="card-img col-md-4">
                        <img src="{{ asset('img/homepage-img/section2-img.jpg') }}" class="img-fluid rounded-start"
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
            ...
            <div class="big-goods-button d-flex">
                ...
                <div class="button-box">
                    <div class="price-button d-flex">
                        ...
                        <button class="btn btn-primary heart" type="submit"><i class="fa-solid fa-heart"></i></button>
                    </div>
                </div>
            </div>
        </div>
